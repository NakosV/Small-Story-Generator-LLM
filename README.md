...
A small and lightweight decoder-only Large Language Model with approximately 76.9 million parameters built for small and creative story generation as part of a university course assignment.
...
The first one is for training the model from scratch on a dataset and the second is for fine tuning it on a different dataset, to apply a particular writing style to it.
